...
NODE_TYPE_MAP: dict[str, dict] = {
    "Application":         {"kind": "rs_Application",    "icon": "fa-apple",          "color": "#4A90D9"},
    "TCC_Permission":      {"kind": "rs_TCCPermission",  "icon": "fa-shield-halved",  "color": "#FF6666"},
    "Entitlement":         {"kind": "rs_Entitlement",    "icon": "fa-key",            "color": "#FFCC00"},
    "XPC_Service":         {"kind": "rs_XPCService",     "icon": "fa-plug",           "color": "#66CC66"},
    "LaunchItem":          {"kind": "rs_LaunchItem",     "icon": "fa-clock",          "color": "#FF9933"},
    "Keychain_Item":       {"kind": "rs_KeychainItem",   "icon": "fa-lock",           "color": "#CC99FF"},
    "MDM_Profile":         {"kind": "rs_MDMProfile",     "icon": "fa-building",       "color": "#999999"},
    "User":                {"kind": "rs_User",           "icon": "fa-user",           "color": "#E0E0E0"},
    "LocalGroup":          {"kind": "rs_LocalGroup",     "icon": "fa-users",          "color": "#88BBDD"},
    "RemoteAccessService": {"kind": "rs_RemoteAccess",   "icon": "fa-network-wired",  "color": "#DD8888"},
    "FirewallPolicy":      {"kind": "rs_Firewall",       "icon": "fa-fire",           "color": "#DDAA44"},
    "LoginSession":        {"kind": "rs_LoginSession",   "icon": "fa-right-to-bracket", "color": "#77CC77"},
    "AuthorizationRight":  {"kind": "rs_AuthRight",      "icon": "fa-gavel",            "color": "#CC6677"},
    "AuthorizationPlugin": {"kind": "rs_AuthPlugin",     "icon": "fa-puzzle-piece",     "color": "#BB7744"},
    "SystemExtension":     {"kind": "rs_SystemExt",      "icon": "fa-microchip",        "color": "#6699BB"},
    "SudoersRule":         {"kind": "rs_SudoersRule",    "icon": "fa-terminal",         "color": "#DD6644"},
    "CriticalFile":        {"kind": "rs_CriticalFile",   "icon": "fa-file-shield",      "color": "#CC4466"},
    "Computer":            {"kind": "rs_Computer",       "icon": "fa-laptop",           "color": "#5588BB"},
    "CertificateAuthority": {"kind": "rs_CertAuthority", "icon": "fa-certificate",      "color": "#AA88CC"},
    "BluetoothDevice":      {"kind": "rs_BluetoothDevice", "icon": "fa-bluetooth-b",    "color": "#0082FC"},
    "KerberosArtifact":     {"kind": "rs_KerberosArtifact", "icon": "fa-ticket",        "color": "#DD4400"},
    "ADGroup":              {"kind": "rs_ADGroup",           "icon": "fa-sitemap",       "color": "#4477AA"},
    "Vulnerability":        {"kind": "rs_Vulnerability",     "icon": "fa-bug",           "color": "#FF4444"},
    "AttackTechnique":      {"kind": "rs_AttackTechnique",   "icon": "fa-crosshairs",    "color": "#FF8800"},
...
def export_cross_domain(session, hostname: str) -> dict:
    ...
    for record in result:
        ...
        # BloodHound CE resolves the target by matching the "target" ID
        # against existing AZUser nodes with the same principal name.
        edges.append({
            "source": rs_id,
